...
def get_Aggl():
    return get_response(jt_algorithm.getJson(request.get_json()))
@app.route("/jt_correlation",methods=["GET","POST"])
def get_corr():
    return get_response(jt_algorithm.correlation(request.get_json()))
